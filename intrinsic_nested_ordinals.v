...
Module Type Signature.
  ...
  Parameter ctor : Type.
  (** The arity of each constructor. *)
  Parameter ctor_arity : ctor -> nat.
  (** The type of each constructor argument. *)
  Parameter ctor_arg_type : forall c, 'I_(ctor_arity c) -> @arg_ty base. 
End Signature.
...
| (* A term constructor, applied to a list of arguments. *)
  T_ctor : forall c, vec (ctor_arity c) (arg term) (ctor_type c) -> term
